...
;--------------------------------------------------------
	.area DSEG    (DATA)
_matrix_draw_active_muster_65536_33:
	.ds 8
_matrix_draw_i_131072_35:
	.ds 2
_matrix_draw_j_262144_37:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;c                         Allocated to registers r7 
;active_muster             Allocated with name '_matrix_draw_active_muster_65536_33'
;i                         Allocated with name '_matrix_draw_i_131072_35'
;j                         Allocated with name '_matrix_draw_j_262144_37'
...
;	matrix.c:178: active_muster = charToMuster(c);
	mov	dpl,r7
	lcall	_charToMuster
	mov	_matrix_draw_active_muster_65536_33,dpl
	mov	(_matrix_draw_active_muster_65536_33 + 1),dph
	mov	(_matrix_draw_active_muster_65536_33 + 2),b
	mov	(_matrix_draw_active_muster_65536_33 + 3),a
	mov	(_matrix_draw_active_muster_65536_33 + 4),r4
	mov	(_matrix_draw_active_muster_65536_33 + 5),r5
	mov	(_matrix_draw_active_muster_65536_33 + 6),r6
	mov	(_matrix_draw_active_muster_65536_33 + 7),r7
;	matrix.c:180: for (int i=0; i<5; i++) {
	clr	a
	mov	_matrix_draw_i_131072_35,a
	mov	(_matrix_draw_i_131072_35 + 1),a
00112$:
	clr	c
	mov	a,_matrix_draw_i_131072_35
	subb	a,#0x05
	mov	a,(_matrix_draw_i_131072_35 + 1)
	xrl	a,#0x80
	subb	a,#0x80
	jc	00149$
	ret
...
;	matrix.c:183: reset_col(i);
	mov	dpl,_matrix_draw_i_131072_35
	mov	dph,(_matrix_draw_i_131072_35 + 1)
	lcall	_reset_col
;	matrix.c:185: for (int j = 0; j<7; j++) {
	clr	a
	mov	_matrix_draw_j_262144_37,a
	mov	(_matrix_draw_j_262144_37 + 1),a
00109$:
	clr	c
	mov	a,_matrix_draw_j_262144_37
	subb	a,#0x07
	mov	a,(_matrix_draw_j_262144_37 + 1)
	xrl	a,#0x80
	subb	a,#0x80
	jnc	00113$
;	matrix.c:186: int index = 5*(6-j) + (4 - i);
	mov	r3,_matrix_draw_j_262144_37
	mov	a,#0x06
	clr	c
	subb	a,r3
	mov	b,#0x05
	mul	ab
	mov	r3,a
	mov	r2,_matrix_draw_i_131072_35
	mov	a,#0x04
	clr	c
	subb	a,r2
	add	a,r3
;	matrix.c:187: bool val = (active_muster >> (34 - index)) & 1;
	...
	mov	b,r3
	inc	b
	mov	r0,_matrix_draw_active_muster_65536_33
	mov	r1,(_matrix_draw_active_muster_65536_33 + 1)
	mov	r2,(_matrix_draw_active_muster_65536_33 + 2)
	mov	r3,(_matrix_draw_active_muster_65536_33 + 3)
	mov	r4,(_matrix_draw_active_muster_65536_33 + 4)
	mov	r5,(_matrix_draw_active_muster_65536_33 + 5)
	mov	r6,(_matrix_draw_active_muster_65536_33 + 6)
	mov	r7,(_matrix_draw_active_muster_65536_33 + 7)
	sjmp	00152$
00151$:
	clr	c
	mov	a,r7
...
;	matrix.c:188: if (val) {
	mov	r7,a
	jz	00110$
;	matrix.c:189: set_row(j);
	mov	dpl,_matrix_draw_j_262144_37
	mov	dph,(_matrix_draw_j_262144_37 + 1)
	lcall	_set_row
00110$:
;	matrix.c:185: for (int j = 0; j<7; j++) {
	inc	_matrix_draw_j_262144_37
	clr	a
	cjne	a,_matrix_draw_j_262144_37,00109$
	inc	(_matrix_draw_j_262144_37 + 1)
	sjmp	00109$
00113$:
;	matrix.c:180: for (int i=0; i<5; i++) {
	inc	_matrix_draw_i_131072_35
	clr	a
	cjne	a,_matrix_draw_i_131072_35,00155$
	inc	(_matrix_draw_i_131072_35 + 1)
00155$:
;	matrix.c:193: }
	ljmp	00112$
;------------------------------------------------------------
